(function () {
  ...
  var wizardCoatColors = ['rgb(101, 137, 164)', 'rgb(241, 43, 107)', 'rgb(146, 100, 161)',
  ...
  var wizardEyesColors = ['black', 'red', 'blue', 'yellow', 'green'];
    ...
    function createWizardsArray(wizardsCount, wizardsNames, wizardsSurnames, wizardCoatColors, wizardEyesColors) {
    ...
    // выводим всех волшебников в блок формы настройки волшебника
    function renderWizards(wizardsFragment, allWizards) {
      for (var i = 0; i <= allWizards.length - 1; i++) {
        wizardsFragment.appendChild(renderWizard(allWizards[i]));
      }
    }
